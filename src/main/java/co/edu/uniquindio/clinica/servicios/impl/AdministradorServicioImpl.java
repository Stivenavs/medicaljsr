...
public class AdministradorServicioImpl implements AdministradorServicio {
    ...
    @Override
    public int crearDoctor(RegistroMedicoDTO medicoDTO) throws Exception {
        ...
        @Override
        public int actualizarDoctor(@NotNull DetalleMedicoDTO medicoDTO) throws Exception {
        ...
        @Override
        public void eliminarDoctor(int codigo) throws Exception {
        ...
        @Override
        public List<ItemMedicoDTO> listarDoctores() throws Exception {
        ...
        @Override
        public DetalleMedicoDTO obtenerDoctor(int codigo) throws Exception {
        ...
        @Override
        public int contestarPQRS(RegistroRespuestaDTO registroRespuestaDTO) throws Exception {
            // Se Obtiene el PQRS
